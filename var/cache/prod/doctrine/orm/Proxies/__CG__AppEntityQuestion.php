...
class Question extends \App\Entity\Question implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'choixes' => [parent::class, 'choixes', null],
        "\0".parent::class."\0".'examens' => [parent::class, 'examens', null],
        ...
        'choixes' => [parent::class, 'choixes', null],
        'examens' => [parent::class, 'examens', null],
