 ...
 */
class Examen extends \App\Entity\Examen implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'passerExamens' => [parent::class, 'passerExamens', null],
        "\0".parent::class."\0".'questions' => [parent::class, 'questions', null],
        'date' => [parent::class, 'date', null],
        'id' => [parent::class, 'id', null],
        'passerExamens' => [parent::class, 'passerExamens', null],
