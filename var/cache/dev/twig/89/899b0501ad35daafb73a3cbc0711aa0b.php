...
/* user/add.html.twig */
class __TwigTemplate_f94f85f5701cfc63df817cf0781d1f3a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"form-field\">
        ";
        // line 54
        if (twig_in_filter("ROLE_SUPERADMIN", twig_get_attribute($this->env, $this->source, (isset($context["current"]) || array_key_exists("current", $context) ? $context["current"] : (function () { throw new RuntimeError('Variable "current" does not exist.', 54, $this->source); })()), "roles", [], "any", false, false, false, 54))) {
            // line 55
            echo "        <select name=\"roles\" class=\"select-roles\">
...
";
    ...
    {
        return array (  215 => 66,  210 => 64,  204 => 60,  197 => 55,  195 => 54,  191 => 52,  185 => 50,  183 => 49,  178 => 47,  172 => 44,  168 => 42,  162 => 40,  160 => 39,  155 => 37,  149 => 34,  145 => 32,  139 => 30,  137 => 29,  132 => 27,  126 => 24,  122 => 22,  116 => 20,  114 => 19,  109 => 17,  103 => 14,  98 => 12,  93 => 9,  86 => 8,  78 => 6,  71 => 5,  61 => 3,  54 => 2,  37 => 1,);
    }
...
{{form_start(form)}}
    ...
    <div class=\"form-field\">
        {% if 'ROLE_SUPERADMIN' in current.roles %}
...
{% endblock %}
", "user/add.html.twig", "/home/firas/Desktop/v2/ACRO/templates/user/add.html.twig");
    }
}
